...
![@a-2-c-2-anpm/eaque-quidem-culpa-diagram-verify](https://cloud.githubusercontent.com/assets/194400/11937081/00f9b4bc-a80a-11e5-9f71-a7e05e92f1ae.png)

[![Known Vulnerabilities](https://snyk.io/test/github/dwyl/@a-2-c-2-anpm/eaque-quidem-culpa/badge.svg?targetFile=package.json&style=flat-square)](https://snyk.io/test/github/dwyl/@a-2-c-2-anpm/eaque-quidem-culpa?targetFile=package.json)
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/dwyl/@a-2-c-2-anpm/eaque-quidem-culpa/ci.yml?label=build&style=flat-square&branch=main)
[![codecov.io](https://img.shields.io/codecov/c/github/dwyl/@a-2-c-2-anpm/eaque-quidem-culpa/main.svg?style=flat-square)](http://codecov.io/github/dwyl/@a-2-c-2-anpm/eaque-quidem-culpa?branch=main)
[![Inline docs](http://inch-ci.org/github/dwyl/@a-2-c-2-anpm/eaque-quidem-culpa.svg?branch=main&style=flat-square)](http://inch-ci.org/github/dwyl/@a-2-c-2-anpm/eaque-quidem-culpa)
[![HAPI 21.1.0](http://img.shields.io/badge/hapi-21.1.0-brightgreen.svg?style=flat-square "Latest Hapi.js")](http://hapijs.com)
[![Node.js Version](https://img.shields.io/node/v/@a-2-c-2-anpm/eaque-quidem-culpa.svg?style=flat-square "Node.js 18.x, 20.x & 21.x supported")](http://nodejs.org/download/)
[![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat-square)](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues)
[![HitCount](http://hits.dwyl.com/dwyl/@a-2-c-2-anpm/eaque-quidem-culpa.svg)](http://hits.dwyl.com/dwyl/@a-2-c-2-anpm/eaque-quidem-culpa)
[![npm package version](https://img.shields.io/npm/v/@a-2-c-2-anpm/eaque-quidem-culpa.svg?style=flat-square)](https://www.npmjs.com/package/@a-2-c-2-anpm/eaque-quidem-culpa)
...
https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues

### Install from NPM

```sh
npm install @a-2-c-2-anpm/eaque-quidem-culpa --save
```
...
const init = async () => {
  ...
  // include our module here ↓↓, for example, require('@a-2-c-2-anpm/eaque-quidem-culpa')
...
```sh
git clone https://github.com/a-2-c-2-anpm/eaque-quidem-culpa.git && cd @a-2-c-2-anpm/eaque-quidem-culpa
```
...
signature `async function(decoded)` where:
    ...
    - Returns an object `{ key, extraInfo }` where:
        ...
        via `request.plugins['@a-2-c-2-anpm/eaque-quidem-culpa'].extraInfo`
    - Throws a Boom error when key lookup fails.  Refer to [this example implementation](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/blob/main/test/dynamic_key_server.js)
    and [its associated test](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/blob/main/test/dynamic_key.test.js) for a working example.
...
[@a-2-c-2-anpm/eaque-quidem-culpa/issues/123](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/123)


### Understanding the Request Flow

At the simplest level this is the request flow through a Hapi App
using `@a-2-c-2-anpm/eaque-quidem-culpa`:
...
This feature was requested in: [issues/29](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/29)
...
[dwyl/@a-2-c-2-anpm/eaque-quidem-culpa/issues/**19**](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/19)
...
> Set your `urlKey` to `false` or ''. (*added by* @bitcloud: [issue #146](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/pull/146))

## Generating Your Secret Key

@skota asked "***How to generate secret key***?" in: [dwyl/@a-2-c-2-anpm/eaque-quidem-culpa/issues/**48**](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/48)
...
[dwyl/@a-2-c-2-anpm/eaque-quidem-culpa/issues/**123**](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/123)
...
[dwyl/@a-2-c-2-anpm/eaque-quidem-culpa/issues/**55**](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/55)
...
[https://github.com/nelsonic/@a-2-c-2-anpm/eaque-quidem-culpa-cookie-example](https://github.com/nelsonic/@a-2-c-2-anpm/eaque-quidem-culpa-cookie-example)
...
[given that **@a-2-c-2-anpm/eaque-quidem-culpa** plugin already includes it] ? asked in 
[@a-2-c-2-anpm/eaque-quidem-culpa/issues/32](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/32)  
...
Even though **@a-2-c-2-anpm/eaque-quidem-culpa** includes it
...
`const JWT = require('./node_modules/@a-2-c-2-anpm/eaque-quidem-culpa/node_modules/jsonwebtoken');`
...
in [issue #120](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/120) and [issue #130](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/130) respectively.
...
### Can I use `@a-2-c-2-anpm/eaque-quidem-culpa` with [`glue`](https://github.com/hapijs/glue)
...
[https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/151#issuecomment-218321212](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/151#issuecomment-218321212)

<br />

### How do I *invalidate* an *existing token*?

Asked by [@SanderElias](https://github.com/SanderElias) in [@a-2-c-2-anpm/eaque-quidem-culpa/issues/126](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/126)
...
[https://github.com/a-2-c-2-anpm/eaque-quidem-culpa-example/blob/791b0d3906d4deb256daf23fcf8f5021905abe9e/index.js#L25](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa-example/blob/791b0d3906d4deb256daf23fcf8f5021905abe9e/index.js#L25)
...
[@abeninskibede](https://github.com/abeninskibede) asked how to set all routes to use JWT Auth in [@a-2-c-2-anpm/eaque-quidem-culpa/issues/149](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/149)

We tend to enable `@a-2-c-2-anpm/eaque-quidem-culpa` for *all* routes by setting the default strategy to 'jwt' (so its `required` for all endpoints) because *most* of the endpoints in our app require the person/user to be authenticated e.g:
...
[ask!](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues)

### How to *redirect* if a token has expired?

@traducer & @goncalvesr2 both requested how to redirect after failed Auth in
[@a-2-c-2-anpm/eaque-quidem-culpa/issues/161](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/161)
and [@a-2-c-2-anpm/eaque-quidem-culpa/issues/148](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/148) respectively
...
While *most* people using `@a-2-c-2-anpm/eaque-quidem-culpa` will opt for the *simpler* use case
...
The [*internals*](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/blob/eb9fff9fc384fde07ec2a1d2f0da520be902da2c/l˜/index.js#L58)
of `@a-2-c-2-anpm/eaque-quidem-culpa` use the `jsonwebtoken.verify` method to ***verify*** if the
...
[https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/120](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/120)
...
**`@a-2-c-2-anpm/eaque-quidem-culpa`** version **`10.x.x`** is an ***optional upgrade***
...
**`@a-2-c-2-anpm/eaque-quidem-culpa`** version **`9.x.x`** is compatible with **Hapi.js `19.x.x`**
which only supports **Node.js 12+**.
While **`@a-2-c-2-anpm/eaque-quidem-culpa`** version `9.0.0`
...
[dropped support for Node.js 10](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/338#issuecomment-583716612)
and people should treat *this* package
as no longer supporting the older versions of Node. <br />

`@a-2-c-2-anpm/eaque-quidem-culpa` version `8.x.x`
is compatible with Hapi.js version `17.x.x` - `19.x.x` <br />

`@a-2-c-2-anpm/eaque-quidem-culpa` version `7.x.x` is compatible with `16.x.x`
...
> *If you have a question, or need help getting started* ***please post an issue/question on GitHub***: https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues
...
The ***code*** is at: https://github.com/a-2-c-2-anpm/eaque-quidem-culpa-example
...
[@a-2-c-2-anpm/eaque-quidem-culpa/issues/9](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues/9)
...
- **app.js** ***registering*** the **@a-2-c-2-anpm/eaque-quidem-culpa plugin**:
...
## Contributing [![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues)

If you spot an area for improvement,
please raise an issue:
https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues <br />
...
## Why @a-2-c-2-anpm/eaque-quidem-culpa ?
...
issue in ***@a-2-c-2-anpm/eaque-quidem-culpa*** please create an issue: https://github.com/a-2-c-2-anpm/eaque-quidem-culpa/issues
so we can get it *resolved* ASAP!

*Aparently, `.some` people like it...*:

[![https://nodei.co/npm/@a-2-c-2-anpm/eaque-quidem-culpa.png?downloads=true&downloadRank=true&stars=true](https://nodei.co/npm/@a-2-c-2-anpm/eaque-quidem-culpa.png?downloads=true&downloadRank=true&stars=true)](https://www.npmjs.com/package/@a-2-c-2-anpm/eaque-quidem-culpa)
